...
# Example Usage
workout = RandoroWorkout(w=5, N=3, r=10, t=10, n=3, d=2, c=5)
print(workout.generate_table(workout.warmup,
            workout.num_rounds,
            workout.rest,
            workout.cooldown,
            workout.round_duration,
            workout.num_intervals,
            workout.min_interval_duration))
workout.generate_randoro_workout()
print(workout.generate_detailed_table(workout.workout))
